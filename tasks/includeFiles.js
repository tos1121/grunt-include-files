...
module.exports = function(grunt) {
  ...
  var parsers = {
    ...
    'scss': parseSource('SCSS', /\/\/\s+include:\s+(.*)/gi),
    'sass': parseSource('SASS', /\/\/\s+include:\s+(.*)/gi),
  ...
  var endMarkerParsers = {
    ...
    'scss': findEndMarker('SCSS', /\/\/\s+\/include/i),
    'sass': findEndMarker('SASS', /\/\/\s+\/include/i),
  ...
  var templates = {
    'html':
    {
      ...
      'toc': '<a href="{filePath}">{fileName}:{baseName}</a>'
    },
    'haml':
    {
